    ...
    <>
      <div style={{ height: "calc( 100vh - 110px )" }} className="p-5 my-5  rounded-xl Custom_Scroll overflow-y-auto bg-white Box_Shedow ">
        ...
        <h2 className="Text_Color text-center font-bold my-2 gap-6 flex justify-center items-center">
          <FaRegNewspaper className="text-indigo-500 " /> Create MCQ paper
        </h2>

        <form className="w-full lg:w-1/2 mx-auto Box_Shedow rounded-xl h-auto p-5" onSubmit={handleSubmit}>
