  ...
  return (
    <>
      <div className=' my-5  text-black flex justify-evenly flex-col lg:flex-row items-center gap-5 lg:gap-10'>
        <img src={Img4} className=' order-2 rounded-xl w-full lg:w-1/2' />
        <div className="text-center  rounded-xl p-5 lg:order-2 bg-white">
      ...
      <div className="text-black p-5 text-justify flex flex-col lg:flex-row justify-evenly rounded-xl bg-white my-5">
        <h1 className=' font-bold'>Key feature</h1>
        <ul>
      ...
      <div className="flex justify-evenly flex-col lg:flex-row items-center gap-5 lg:gap-20 my-5">
        ...
        <img src={Img6} className='lg:w-1/3 rounded-full ' />
      </div>

      <div className=" rounded-xl p-6 text-center">
      <h2 className=" font-bold bg-white rounded-xl mb-8">
